...
$countCompareProducts = count($checkIfToCompare);
...
if (isset($_POST['compareProduct'])) {
    $pId = $_POST['proId'];
    $pName = $_POST['proName'];

    echo "<script>
    window.location = 'compare_products.php?pName=$pName&id=$pId';
    </script>";
}
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <li><a href="#" class="text-dark mb-2"><span>Availibility</span> :
                            <?= $eachProduct['quantity'] ? 'In Stock' : 'Out of Stock' ?></a></li>
                    <p class="mt-3"> <strong class="text-primary mt-3 h4 mt-3 mb-2 text-danger">RS: <?= $eachProduct['pPrice'] ?> PKR</strong></p>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="input-group mb-3" style="max-width: 120px;">
                                <div class="input-group-prepend mr-2">
                                    ...
                                    <input class="product_count_item text-center input-number ml-2" type="number" name="qty" value="1" min="1" max="1">
                            ...
                            ?>
                            <?php
                            if ($countCompareProducts > 1) {
                            ?>
                                <input type="hidden" name="proId" value="<?= $eachProduct['pId'] ?>">
                                <input type="hidden" name="proName" value="<?= $eachProduct['pName'] ?>">
                                <!-- <span>
                                    <a href="product_details.php?pName=<?= $eachProduct['pName'] ?> & id=<?= $eachProduct['pId'] ?>"> Add to cart</a>
                                </span> -->
                                <input type="submit" class="mt-4 buy-now btn btn-sm height-auto px-4 py-3 btn-primary" name="compareProduct" value="Compare Product">
                            <?php
                            }
                            ?>
                    </form>
