...
if (isset($_SESSION['Logged_in']) && $_SESSION['user_type'] == 'seller') {
    ...
    if (isset($_POST['addproduct'])) {
        ...
        if ($_FILES['pImage']['size'] != 0) {
            ...
            $add = $addProduct->addProduct($catId, $quantity);
        }
    }
} else {
    echo "<script>
            ...
            <div class="row mb-4 ml-2 mr-2">
                ...
                <div class="col-md-6 ml-4">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <br>
                        <textarea class="text-dark form-control" name="pDesc" type="text" rows="10" placeholder="Product Description" required></textarea>


                        <br><input type="number" name="pPrice" placeholder="Product Price" class="form-control" required />
                        <br>
                        <h4 class="pt-2 mt-2">Product Quantity</h4>

                        <input type="quantity" name="quantity" placeholder="Product quantity" class="form-control" required />
                        <br>
                        ...
                        <br>
                        <input type="submit" class="btn btn-block bg-success" name="addproduct" value="Add Product" class="btn btn-primary">
                    </form>
                </div>
